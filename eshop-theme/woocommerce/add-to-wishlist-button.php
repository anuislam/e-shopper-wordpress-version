...
<img src="<?php echo esc_url( YITH_WCWL_URL . 'assets/images/wpspin_light.gif' ) ?>" class="ajax-loading eship_wishlist_loader" alt="loading" width="16" height="16" style="visibility:hidden" />